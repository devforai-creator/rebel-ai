...
- [LorebookPanel.tsx](/home/tmdduq96kr/projects/rebel-ai/src/app/dashboard/chats/[id]/LorebookPanel.tsx) now delegates override identity helpers and grouping/preview utilities to [lorebook-panel.ts](/home/tmdduq96kr/projects/rebel-ai/src/app/dashboard/chats/[id]/utils/lorebook-panel.ts), so the panel shell no longer mixes chat-scoped override orchestration with fingerprinting, flattening, and preview-formatting details inline
- [LorebookPanel.tsx](/home/tmdduq96kr/projects/rebel-ai/src/app/dashboard/chats/[id]/LorebookPanel.tsx) now also delegates folder/search content rendering to [LorebookPanelContent.tsx](/home/tmdduq96kr/projects/rebel-ai/src/app/dashboard/chats/[id]/components/LorebookPanelContent.tsx) and per-entry override/preview rendering to [LorebookEntryRow.tsx](/home/tmdduq96kr/projects/rebel-ai/src/app/dashboard/chats/[id]/components/LorebookEntryRow.tsx), which turns the previous all-in-one lorebook surface into a shell plus explicit content/row seams
- the extracted lorebook seams now carry direct regression coverage in [lorebook-panel.test.ts](/home/tmdduq96kr/projects/rebel-ai/src/app/dashboard/chats/[id]/utils/lorebook-panel.test.ts) and [LorebookEntryRow.test.tsx](/home/tmdduq96kr/projects/rebel-ai/src/app/dashboard/chats/[id]/components/LorebookEntryRow.test.tsx), which lock flattening/preview behavior and expanded-entry rendering while the panel shell stays small
- [LorebookPanel.tsx](/home/tmdduq96kr/projects/rebel-ai/src/app/dashboard/chats/[id]/LorebookPanel.tsx) is down to `261` lines from its previous `771`, so the `chats/[id]` UI cluster is now much closer to the intended state/orchestration-shell shape across its largest panels
