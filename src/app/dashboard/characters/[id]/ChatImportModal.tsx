  ...
  async function handleImport() {
    ...
    try {
      ...
      if (result.success) {
        onClose()
        router.refresh()
        // Choose to navigate to newly created chat
        if (result.chatId && confirm(`Imported ${result.messageCount} messages.\n\nGo to chat?`)) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full mx-4 p-6">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Import Chat</h3>
