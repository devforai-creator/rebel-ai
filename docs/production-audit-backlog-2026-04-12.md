...
- [ChatSummariesPanel.tsx](/home/tmdduq96kr/projects/rebel-ai/src/app/dashboard/chats/[id]/ChatSummariesPanel.tsx) is down to `666` lines from its previous `915`, so the remaining size is now mostly repeated section rendering rather than mixed subscriptions, mutations, and memory-view derivation
